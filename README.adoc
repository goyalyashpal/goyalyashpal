...
:i_conv_commits: image:{imgb}buildable_commits-FE5196?logo=conventionalcommits{badge_params}[title="Buildable Commits"]
...
// https://nix.dev/tutorials/nix-language.html#interactive-evaluation[nixeval]
|===
